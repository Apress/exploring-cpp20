...
template<class T, int N>
constexpr fixed<T,N>::fixed(value_type integer, value_type fraction)
{
  if (fraction < T())
...
template<class T, int N>
constexpr typename fixed<T,N>::value_type fixed<T,N>::reduce(value_type frac)
{
...
template<class T, int N>
constexpr typename fixed<T,N>::value_type fixed<T,N>::round()
const
{
...
template<class T, int N>
std::string fixed<T,N>::to_string()
const
{
